...
use model_registry_sdk::models::{
    ApprovalStatus, ContextWindow, CreateModelRequestV1, CreateProviderRequestV1, LifecycleStatus,
    ModelCapabilities, ModelInfoV1, ModelPerformance, ModelV1, ProviderStatus, ProviderV1,
    SupportedApi, UpdateModelRequestV1, UpdateProviderRequestV1,
};
use sea_orm::Set;
use uuid::Uuid;
